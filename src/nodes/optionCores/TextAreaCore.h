#ifndef TEXTAREACORE_H_INCLUDED
#define TEXTAREACORE_H_INCLUDED

#include "OptionCore.h"

//documentation in OptionCore.h
namespace option_cores{
    class TextAreaCore : public OptionCore{
    private:
    ...
    public:
         ...
         *
         */
        TextAreaCore(node_components::Option* shell);
